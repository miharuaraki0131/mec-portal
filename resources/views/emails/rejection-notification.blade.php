...
<body style="font-family: 'Hiragino Sans', 'ヒラギノ角ゴシック', 'Yu Gothic', '游ゴシック', Meiryo, 'メイリオ', sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <h1 style="color: #DC2626; border-bottom: 2px solid #DC2626; padding-bottom: 10px;">差戻通知</h1>
        
        <p style="margin-top: 20px;">申請が差戻されました。内容をご確認の上、修正して再度申請してください。</p>
        ...
        <div style="background-color: #F3F4F6; padding: 15px; border-radius: 8px; margin: 20px 0;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    <td style="padding: 8px 0; font-weight: bold;">差戻者:</td>
                    <td style="padding: 8px 0;">{{ $approval->approver->name }}</td>
                </tr>
                <tr>
                    <td style="padding: 8px 0; font-weight: bold;">差戻日時:</td>
                    <td style="padding: 8px 0;">{{ $approval->approved_at->format('Y年m月d日 H:i') }}</td>
                </tr>
                <tr>
                    <td style="padding: 8px 0; font-weight: bold;">差戻理由:</td>
                    <td style="padding: 8px 0; color: #DC2626; font-weight: bold;">{{ $approval->comment }}</td>
                </tr>
            </table>
        </div>
